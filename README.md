...
<li>I'm a median OSDD-1A traumagenic Plural while i'm ok with any systems interacting as long we're buddy buddies(including endogenics,,).</li>
<li> i am Medkit introject + fictionkin,, yes this isn't inheriting Medkit himself bbbutt,, you can refer to it as source, however.
...
<li>I have mood swings, yes. I can be happy and go-lucky all the time, then I can be sad and angry for a while. Suisicdal ,,</li>
...
<li>I AM <B>AM</B> IRL, i do not mind doubles with my kintypes. But hey if you're uncomfy w/ doubles, I'll respect that.</li>
